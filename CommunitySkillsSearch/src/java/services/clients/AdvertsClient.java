 ...
 * Web services client for advert table
 */
...
/**
 * Jersey REST client generated for REST resource:AdvertsFacadeREST
 * [entities.adverts]<br>
 * USAGE:
 * <pre>
 *        AdvertsClient client = new AdvertsClient();
...
public class AdvertsClient {
    ...
    public AdvertsClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.adverts");
    }
