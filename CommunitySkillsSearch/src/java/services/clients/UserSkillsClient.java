 ...
 * Web services client for UserSkills database table
 */
...
/**
 * Jersey REST client generated for REST resource:UserSkillsFacadeREST
 * [entities.userskills]<br>
 * USAGE:
 * <pre>
 *        UserSkillsClient client = new UserSkillsClient();
 ...
 */
public class UserSkillsClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/CommunitySkillsSearch/webresources";

    public UserSkillsClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.userskills");
    }
