 ...
 * Web services client for skill table
 */
...
/**
 * Jersey REST client generated for REST resource:SkillsFacadeREST
 * [entities.skills]<br>
 * USAGE:
 * <pre>
...
public class SkillsClient {
    ...
    public SkillsClient() {
        ...
        webTarget = client.target(BASE_URI).path("entities.skills");
    }
