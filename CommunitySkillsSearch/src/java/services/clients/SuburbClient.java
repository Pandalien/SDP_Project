 ...
 * Web services client for suburb table
 */
...
/**
 * Jersey REST client generated for REST resource:SuburbFacadeREST
 * [entities.suburb]<br>
 * USAGE:
 * <pre>
 *        SuburbClient client = new SuburbClient();
...
public class SuburbClient {
    ...
    public SuburbClient() {
        ...
        webTarget = client.target(BASE_URI).path("entities.suburb");
    }
