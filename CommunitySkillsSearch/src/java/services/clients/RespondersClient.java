 ...
 * Web services client for responders table
 */
...
/**
 * Jersey REST client generated for REST resource:RespondersFacadeREST
 * [entities.responders]<br>
 * USAGE:
 * <pre>
 *        RespondersClient client = new RespondersClient();
 ...
 */
public class RespondersClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/CommunitySkillsSearch/webresources";

    public RespondersClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entities.responders");
    }
