 ...
 * Web services client for Requirement table
 */
...
/**
 * Jersey REST client generated for REST resource:RequirementsFacadeREST
 * [entities.requirements]<br>
 * USAGE:
 * <pre>
...
public class RequirementClient {
    ...
    public RequirementClient() {
        ...
        webTarget = client.target(BASE_URI).path("entities.requirements");
    }
